# moot-math-benchmark port hints — Go

A one-shot guide to add a Go port of the moot-math-benchmark benchmarks.
...
└── go/
    ├── go.mod                       module moot-math-benchmark-go
    ├── cmd/
    │   ├── topk-bench/main.go
    │   └── stress-test/main.go
    └── internal/
...
```sh
cd apps/moot-math-benchmark/go
