...
```
apps/moot-math-benchmark/results/{YYYY-MM-DD}-{hardware-slug}/
  {op}-{language}.json
```
...
under `apps/moot-math-benchmark/results/{date}-{hardware-tag}/`. The
...
Full sweep: apps/moot-math-benchmark/results/2026-05-18-apple-m5-max/
            or_reduce-rust.json
```
