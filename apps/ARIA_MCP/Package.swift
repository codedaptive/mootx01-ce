    ...
    targets: [
        ...
        .executableTarget(
            ...
            dependencies: [
                ...
                // Resident-daemon composition (telemetry + Brain pump + monitoring
                // gate + HTTP transport) lives in AriaResident; the executable is a
                // thin caller. The direct ObserverSink/IntellectusLib deps moved to
                // AriaResident (ADR-LOOPBACKHTTP-001) so the JSON-RPC core stays telemetry-free.
                "AriaResident",
            ],
