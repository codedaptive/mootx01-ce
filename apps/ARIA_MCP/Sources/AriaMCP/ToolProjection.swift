    ...
    private static func coreMemoryTools() -> [ProjectedTool] {
        [
            ...
            ProjectedTool(
                ...
                description: "Apply a named mutation to an existing memory (confirm, reject, contest, resolve, supersede, revive, accept).",
                inputSchema: withEstateID(objectSchema(
                    properties: [
                        "id": stringSchema("Memory row identifier."),
                        "mutation": stringSchema("Mutation kind: confirm, reject, contest, resolve, supersede, revive, accept."),
    ...
    private static func knowledgeGraphTools() -> [ProjectedTool] {
        [
            ...
            ProjectedTool(
                ...
                description: "Read all knowledge-graph facts in chronological order, including retired ones, to trace how the estate's structured knowledge evolved.",
                inputSchema: withEstateID(objectSchema(
                    properties: [:],
                    required: []
                )),
