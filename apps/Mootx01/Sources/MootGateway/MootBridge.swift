...
//
// Wiring is the same three steps examples/Sidecar_Demo_macOS's `MootSidecar`
...
// apps/ARIA_MCP/Sources/AriaMCP/Server.swift — so the full JSON-RPC envelope
...
public actor MootBridge {
    ...
    public func callTool(_ name: String, arguments: [String: JSONValue]) async -> GatewayCall {
