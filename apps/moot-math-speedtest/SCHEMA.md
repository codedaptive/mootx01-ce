# moot-math-speedtest output schema
...
The historical retrieval gauntlet is owned by `benchmarks/`,
...
`apps/moot-math-speedtest/results/<date>-<hardware-tag>/`.

Examples:

- `apps/moot-math-speedtest/results/2026-05-22-apple-m5-max/hamming_topk-rust.json`
- `apps/moot-math-speedtest/results/2026-05-22-apple-m5-max/hamming_topk-swift.json`
- `apps/moot-math-speedtest/results/2026-05-22-apple-m5-max/hamming_topk-go.json` ← *your contribution*
