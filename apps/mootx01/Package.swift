...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(
            ...
            // compiles the flat-layout capsule; this define compiles the one
            // block in InstallCommand/UpgradeCommand that calls it. Both go when the floor
            // rises above format 1.8.
