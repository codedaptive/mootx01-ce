...
// apps/mootx01/Contracts/community-1.1/contract.json. They are embedded here so
...
// equals the golden value in apps/mootx01/Contracts/community-1.1/fixture-bundle.sha256.
//
...
/// apps/mootx01/Contracts/community-1.1/contract.json exactly.
public enum CommunityContractConstants {

    /// JSON-LD-style identifier for this contract family.
    /// Source: apps/mootx01/Contracts/community-1.1/contract.json "contractID".
    ...
    /// Source: apps/mootx01/Contracts/community-1.1/contract.json "contractVersion".
    public static let contractVersion = "1.1.0"

    /// The hash algorithm used for the fixture-bundle digest.
    /// Source: apps/mootx01/Contracts/community-1.1/contract.json "fixtureDigestAlgorithm".
    ...
    /// apps/mootx01/Contracts/community-1.1/fixture-bundle.sha256.
