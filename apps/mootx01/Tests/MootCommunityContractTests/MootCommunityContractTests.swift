...
private struct ContractFixtures {
    ...
    static let contractRoot: URL = {
        ...
        // Default: derive the repository root from this file's own location.
        // apps/mootx01/Tests/MootCommunityContractTests/<this file> is four
        // levels below the root, so a hardcoded worktree path is neither
        // needed nor portable.
