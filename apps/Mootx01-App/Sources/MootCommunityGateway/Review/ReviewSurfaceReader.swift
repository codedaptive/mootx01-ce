...
//     Sources/MootProUI (see MootProUI/DaemonController.swift), MootProUI
...
public struct MootToolCallingReviewReader: ReviewSurfaceReading {
    ...
    public init(caller: any MootEstateCalling) {
        self.caller = caller
    }

    public func call(_ surface: ReviewSurface, arguments: [String: JSONValue]) async -> ReviewToolResponse {
        let result = await caller.callToolFull(surface.rawValue, arguments: arguments)
