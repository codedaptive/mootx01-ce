# MatrixSprint port hints — Python

A one-shot guide to add a Python port of the MatrixSprint benchmarks.
...
```sh
cd apps/MatrixSprint/MatrixSprintPython
python3 -m matrix_sprint.bin.topk_bench --quick \
...
python3 -m matrix_sprint.bin.topk_bench --quick --out /tmp/py.json
