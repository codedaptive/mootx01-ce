# MatrixSprint output schema

Every MatrixSprint port — Rust, Swift, Go, Python, anything else
...
`apps/MatrixSprint/results/<date>-<hardware-tag>/`.

Examples:

- `apps/MatrixSprint/results/2026-05-22-apple-m5-max/hamming_topk-rust.json`
- `apps/MatrixSprint/results/2026-05-22-apple-m5-max/hamming_topk-swift.json`
- `apps/MatrixSprint/results/2026-05-22-apple-m5-max/hamming_topk-go.json` ← *your contribution*
