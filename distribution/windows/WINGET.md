...
The public repository's `.github/workflows/release.yml` (the lane that
publishes to winget; the development lane ships no public Windows build and
signs nothing) runs on a `vX.Y.Z` tag:
