...
//
// The OS-bound capture loop lives in NexusIOS and NexusMacOS;
...
/// FNV-1a 64-bit. Substrate-canonical, used by every extractor
/// for string-to-subhash mapping. Matches the implementation in
/// glref-rust-fingerprint256 fnv64() exactly.
@inlinable
internal func fnv64(_ s: String) -> UInt64 {
...
public struct ScreenTimeExtractor {
    ...
    public func extract(_ s: ScreenTimeSample,
                        ...
                        rowId: RowId) -> AmbientSampleRow {
        var subhashes = Array<UInt64>(repeating: 0, count: 4)
        subhashes[0] = fnv64(s.appBundleId)
        subhashes[1] = fnv64(s.categoryIdentifier)
