...
test-harness/
├── README.md                            this file
├── primitive-catalog.md                 all 18 primitives, CRCs, references
...
│
├── vectors/                             18 canonical conformance JSON files
...
four-way matrix across all 18 primitives on every push and PR.
