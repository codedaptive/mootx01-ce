...
For the engineering catalog of all 29 primitives, see
...
test-harness/
├── README.md                            this file
├── primitive-catalog.md                 all 29 primitives, CRCs, references
...
│
├── vectors/                             29 canonical conformance JSON files
│                                        (one per primitive, generated by Swift,
│                                        verified bit-identical against Rust)
│
├── rust/                         Rust harness (library + generator/validator binaries)
│   ├── Cargo.toml
│   ├── Cargo.lock
│   └── src/
│       ├── lib.rs
...
│
└── swift/                        Swift package (library + executables)
    ├── Package.swift
    ├── Sources/
    │   ├── GenVectors/           swift run gen-vectors
    │   ├── ValidateVectors/      swift run validate-vectors
    │   ├── NTP0Bakeoff/          swift run nt-p0-bakeoff
    │   ├── PlatformCryptoCandidate/
    │   │                           CryptoKit SHA/HMAC bakeoff candidate
...
four-way matrix across all conformant primitives on every push and PR.
