...
public enum AuditValue: Hashable, Sendable, Codable {
    ...
    // Rust serde; F16.B (2026-05-27) removed the former `.null` case
    // in favor of Optional<AuditValue> at the AuditEntry level.
}
...
**Rust:** `RowState` (`repr(u8)`, same ordinals), `RowVerb`
