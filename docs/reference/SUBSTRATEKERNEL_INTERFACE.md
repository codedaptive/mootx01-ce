...
/// KeyedCommitment (SubstrateLib the node-integrity contract §17).
...
in SubstrateLib (the node-integrity contract §17). The function was promoted from
...
SubstrateLib (the node-integrity contract §17).
