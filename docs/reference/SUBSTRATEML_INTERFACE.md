...
### 1.0.0 -- 2026-06-14
Established under VERSIONING.md: version number removed from the filename; front matter normalized; baselined at 1.0.0.- **1.5.0 (2026-08-20)** — `DistillationPipelineVersion.current` = "p2.2-det".
