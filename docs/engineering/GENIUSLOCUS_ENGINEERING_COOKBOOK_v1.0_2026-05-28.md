...
purpose: dense mathematical and computational specification for the
         ...
         where needed to implement. Integrates the v0.36 mathematical
...
relates_to:
  ...
  - docs/engineering/HARNESS_REFERENCE_v1.0_2026-05-28.md (the 23 conformance-gated primitives, agentic discovery index)
  ...
  - docs/reference/GENIUSLOCUS_THESIS_RFC.md (why; out of scope here)
---

# GeniusLocus Engineering Specification Cookbook — v1.0
...
5. **Conformance harness at 23 primitives (rewritten §18).** The
   ...
   0x54f6c65f; see §18.2.) `HARNESS_REFERENCE_v1.0_
   2026-05-28.md` is the agentic discovery index — every kit and
   every future port consults it first to avoid reinventing the
   wheel (I-25 enforcement).
...
(see `HARNESS_REFERENCE_v1.0_2026-05-28.md`) has exactly one
...
gated; see `HARNESS_REFERENCE_v1.0_2026-05-28.md` §2.3 for the
...
`tombstoned` is the only terminal state. Conformance: from
`tombstoned` no further mutation is accepted; the
DrawerStateValidator returns
`SubstrateError.invalidStateTransition` for all attempted
transitions.
...
2. Pass all 22 cross-language-pinned conformance vectors at their
   ...
   `HARNESS_REFERENCE_v1.0_2026-05-28.md` §2; the gate is run at
...
the F18.2b post-v1.0 promotion; see HARNESS_REFERENCE_v1.0 for
