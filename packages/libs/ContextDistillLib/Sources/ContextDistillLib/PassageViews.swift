...
/// Prototype lossless dependency-group view. Spans use half-open Unicode scalar
/// offsets into the frozen input; budgets and returnedBytes count UTF-8 bytes.
public struct PassageViewResult: Codable, Equatable, Sendable {
    ...
    enum CodingKeys: String, CodingKey {
        case version, text, continuation, complete, budget, spans
        case fullText = "full_text", budgetHonored = "budget_honored"
        case returnedBytes = "returned_bytes", groupOrder = "group_order"
    }
}
