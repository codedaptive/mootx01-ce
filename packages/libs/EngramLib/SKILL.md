...
when_not_to_use: |
  Do NOT use when:
    ...
    - Anything under the "engineering by wallet" methodology
---
...
implementations: Swift (`/Users/bob/devlop/mootx01/EngramLib`) and
Rust (`/Users/bob/devlop/mootx01/engram-kit`).

## Install

**Swift:** `.package(path: "../EngramLib")` then `import EngramLib`.

**Rust:** `engram-kit = { path = "../engram-kit" }` then
...
Not required to ask before consuming the existing API in product
code.
