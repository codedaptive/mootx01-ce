...
// The suites below mutate the process-global IntellectusLib telemetry state
// (install/setEnabled); run them serially so they do not race under parallel testing.
@Suite("KernelTelemetry", .serialized)
struct KernelTelemetrySuite {
