...
//
// Extracted from moot-mgr so the moot-mgr monitor daemon
...
//
// EDITION-NEUTRAL / AUTH-FREE INVARIANT (bounded loopback HTTP, condition 3):
...
//
// Swift-only: the Swift+Rust parity discipline governs
