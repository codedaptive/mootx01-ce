...
// from LatticeKit) and the canon entry's Wikidata Q-ID. Pure Swift,
...
// LatticeKit (the CC0/public-domain MDCC canon) and on no other kit.
...
let package = Package(
    ...
    dependencies: [
        .package(path: "../../kits/LatticeKit"),
    ],
    targets: [
        .target(
            name: "EideticLib",
            dependencies: [
                .product(name: "LatticeKit", package: "LatticeKit"),
            ],
            resources: [
                .process("Resources"),
            ]
