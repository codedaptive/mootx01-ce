...
impl V2DataMobilityLower for Lower {
    ...
    fn json_import(&self, _: &V2DataMobilityAdmission, _: &V2JsonImportRequest) -> Result<V2JsonImportReport, V2JsonImportLowerError> { Ok(V2JsonImportReport { seed_name: "seed".to_owned(), drawers_written: 0, facts_written: 0, tunnels_created: 0, enqueued_for_encode: 0, subjects_provided: 0, subjects_debt: 0, seed_sha256: "0".repeat(64), id_map: None }) }
