...
fn lens_data_schema(name: &str) -> Option<Value> {
    match name {
        ...
        "moot_lens_contradiction" => Some(
            json!({"type":"object","properties":{"contradictsTunnels":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"sourceDrawerId":{"type":"string"},"targetDrawerId":{"type":"string"},"lifecycle":{"type":"string","enum":["active","proposed"]}},"required":["id","lifecycle"],"additionalProperties":false}},"conflictingFacts":{"type":"array","items":{"type":"object","properties":{"subject":{"type":"string"},"predicate":{"type":"string"},"objects":{"type":"array","items":{"type":"string"}}},"required":["subject","predicate","objects"],"additionalProperties":false}},"totalContradictionCount":{"type":"integer","minimum":0},"totalConflictingFactGroupCount":{"type":"integer","minimum":0},"withheldContradictionCount":{"type":"integer","minimum":0},"withheldConflictingFactGroupCount":{"type":"integer","minimum":0}},"required":["conflictingFacts","contradictsTunnels","totalConflictingFactGroupCount","totalContradictionCount","withheldConflictingFactGroupCount","withheldContradictionCount"],"additionalProperties":false}),
        ),
