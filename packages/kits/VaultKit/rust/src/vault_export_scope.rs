...
//! partitions by the data-movement privacy tiers tier predicates and reports per-tier
//! exclusion counts.
...
impl VaultExportScope {
    ...
    /// data-movement privacy tiers tier rules after recall so per-tier exclusion counts are
