...
//! `FloatRankFixture` in Tests/SynapseKitTests/FloatLaneStoreTests.swift and
//! MUST stay byte-for-byte in sync.

use std::sync::Arc;
use persistence_kit::{inmemory::InMemoryStorage, Storage};
use uuid::Uuid;
use synapsekit::{engine::metric::FloatMetric, EmbeddingProvider, FloatSimHashEmbeddingProvider, VectorPayload, VectorStore};
...
// `floatIndexSurvivesReopenSQLite` (Tests/SynapseKitTests/FloatLaneStoreTests).
// ---------------------------------------------------------------------------
