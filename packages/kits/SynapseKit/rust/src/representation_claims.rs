...
impl VectorRepresentationClaims {
    ...
    pub fn release_all_claims(&self, consumer: &str) -> Result<(), SynapseKitError> {
        self.storage
            .row_store()
            .delete(
                "vector_rep_claims",
    ...
    pub fn claimants(&self, key: &VectorRepresentationKey) -> Result<Vec<String>, SynapseKitError> {
        let rows = self
            .storage
            .row_store()
            .query(
    ...
    pub fn claims(&self, consumer: &str) -> Result<Vec<VectorRepresentationKey>, SynapseKitError> {
        let rows = self
            .storage
            .row_store()
            .query(
    ...
    pub fn is_unclaimed(&self, key: &VectorRepresentationKey) -> Result<bool, SynapseKitError> {
