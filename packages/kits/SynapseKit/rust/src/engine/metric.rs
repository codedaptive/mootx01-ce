...
//! Both metric families are owned by SynapseKit: dense-embedding distance
//! is a SynapseKit concern (SynapseKit-owned vector search persistencekit-vector-contract-correction).
//!
...
/// Float distance metric for float32 / int8 vector lanes. SynapseKit-owned
