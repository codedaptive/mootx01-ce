...
//!   degrades latency, never correctness. The `synapsekit.mih.enumeration_fallback`
        ...
        loop {
            ...
            if mask_count.saturating_add(projected) > budget {
                ...
                if !is_exact {
                    ...
                    // `Intellectus.report(.metric("synapsekit.mih.enumeration_fallback"))`
                    ...
                    report!({
                        ...
                        StatSample::metric(
                            "synapsekit.mih.enumeration_fallback".to_string(),
                            1.0,
                            tags,
                            ts,
                        )
