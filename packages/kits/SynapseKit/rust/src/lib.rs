//! SynapseKit -- on-device embedding generation and persistence-kit-backed
//! vector storage. Parallel to the Swift `SynapseKit` Swift Package.
//!
...
//!   backends both ship and are both exercised by SynapseKit's tests; over
...
//!   here. See SYNAPSEKIT_SPEC §cross-restart persistence.
