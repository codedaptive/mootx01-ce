...
/// SynapseKit spec) and providers are typically shared across actors.
public protocol EmbeddingProvider: Sendable {
    ...
    /// - Throws: `SynapseKitError.embeddingFailed` on inference failure,
    ///   `SynapseKitError.modelUnavailable` if the model is not loaded.
    ...
    /// - Throws: `SynapseKitError.embeddingFailed` by default — float
