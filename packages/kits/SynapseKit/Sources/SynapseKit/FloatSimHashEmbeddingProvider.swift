...
//
// The concrete EmbeddingProvider for SynapseKit. Swift mirror of the
// Rust synapsekit::FloatSimHashEmbeddingProvider.
//
...
//
// SynapseKit does not own tokenization, model bundles, or model
// identity. Concrete text providers that carry a tokenizer and a
// model-specific projection seed (MiniLM, mpnet, EmbeddingGemma)
// live in CorpusKitProviders and conform to SynapseKit.EmbeddingProvider.
