...
// (cosine, l2, dot — SynapseKit's FloatMetric). Both metric families
// are owned by SynapseKit: dense-embedding distance is a SynapseKit
// concern (SynapseKit-owned vector search persistencekit-vector-contract-correction).
//
...
///
/// SynapseKit owns this type: dense-embedding distance is a SynapseKit
/// concern (SynapseKit-owned vector search persistencekit-vector-contract-correction). The float
...
/// SynapseKit's own FloatMetric (cosine, l2, dot).
