// SynapseKit.swift
//
// SynapseKit provides on-device embedding generation and model-tagged
...
//
// Per spec I-12, SynapseKit composes onto the substrate kit stack via
// EngramLib's `Engram` type as the canonical 256-bit vector
// representation. SynapseKit does not see substrate kernel selection.
//
// Consumers `import EngramLib` to use the `Engram` type alongside
// SynapseKit. This kit does not re-export it — keeping the import
