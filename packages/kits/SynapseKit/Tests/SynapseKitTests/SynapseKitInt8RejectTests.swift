// SynapseKitInt8RejectTests.swift
//
...
@Suite("SynapseKitInt8Reject", .serialized)
struct SynapseKitInt8RejectTests {
    ...
    @Test func addPayload_int8_throwsRejectionError() async throws {
        ...
        // Confirm the specific error case — not just any SynapseKitError.
        do {
            try await store.addPayload(
                itemID: "item-int8-test",
                vectorIndex: 0,
        ...
        } catch let err as SynapseKitError {
    ...
    @Test func addPayload_int8_errorMessageIsInformative() async throws {
        ...
        do {
            ...
            if case let .int8QuantizationPolicyUndefined(msg) = err {
                ...
                #expect(msg.contains("SYNAPSEKIT_SPEC"),
