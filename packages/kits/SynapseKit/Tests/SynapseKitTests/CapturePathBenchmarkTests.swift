...
/// target — `SynapseKit/Package.swift` (immutable per CLAUDE.md) declares
...
///
///     MOOTX01_PERF=1 swift test --package-path packages/kits/SynapseKit
...
struct CapturePathBenchmarkTests {
    ...
    @Test func testEndToEndCapturePathP99Under100Milliseconds() async throws {
        ...
        // To run with thresholds enforced: MOOTX01_PERF=1 swift test --package-path packages/kits/SynapseKit
    ...
    /// size matches the documented retrieval scale ceiling for SynapseKit
