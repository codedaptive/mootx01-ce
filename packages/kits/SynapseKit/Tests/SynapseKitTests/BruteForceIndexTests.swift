...
struct BruteForceIndexTests {
    ...
    @Test func nonBinaryProbeThrows() async throws {
        ...
        } catch SynapseKitError.invalidPayload { /* expected */ }
    }
...
struct ResidentArrayStoreTests {
    ...
    private func tmpURL() -> URL {
        FileManager.default.temporaryDirectory
            .appendingPathComponent("synapsekit-lane-a-\(UUID().uuidString).vec")
    }
    ...
    @Test func badMagicThrowsDecodingFailure() {
        ...
        } catch SynapseKitError.decodingFailure { /* expected */ }
