...
//
// Hardcoded seed values for the bundled minilm-l6-v2-w60 encoder model.
...
public enum EncoderModelSeed {
    ...
    public static let maxSequence: Int = 256
}
