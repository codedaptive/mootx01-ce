...
//!     ext                 JSON                  -- forward-compat slot (nullable entity ext slots, v2); nullable, NULL in 1.0
        ...
        SchemaDeclaration::new(
            ...
            vec![TableDeclaration::new(
                ...
                vec![
                    ...
                    // nullable entity ext slots forward-compat slot (v2). Nullable JSON; 1.0 omits
