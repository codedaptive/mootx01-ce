...
//
// A GeniusLocus estate is a composition of three kits:
//
//   LocusKit  — 13 tables (drawers, tunnels, diary, manifest, kg_facts,
...
// identifier and the sum of component versions. Components: LocusKit v2
// + VectorKit v3 + CorpusKit (BundleStore) v2 = 7. (BasisStore is the
...
public enum GeniusLocusKitSchema {
    ...
    /// Components: LocusKit v2 + VectorKit v3 + CorpusKit (BundleStore) v2 = 7.
    ...
    /// under the "GeniusLocusKit" kit ID and version 7. The caller passes
    /// this to:
