...
# from KaLM-Embedding/LMEB on HuggingFace into the external fixture store.
#
...
DATA_DIR="$BENCH_WORK_ROOT/fixtures/lmeb/data/ConvoMem"
...
echo ""
echo "Run from benchmarks/: make measure-lmeb-spec PORT=swift"
