...
# the external BENCH_WORK_ROOT fixture store. Data never enters the repo.
#
...
DATA_DIR="$BENCH_WORK_ROOT/fixtures/locomo/data"
...
echo ""
echo "Run from benchmarks/: make measure-locomo-spec PORT=swift"
