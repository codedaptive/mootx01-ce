...
/// failed to land.
/// Public so out-of-package callers can score
/// primary-vs-secondary divergence using the same algorithm.
public func jaccardDivergence(expected: Set<String>, got: Set<String>) -> Double {
...
/// Public so out-of-package callers can score
/// primary-vs-secondary rank divergence using the same algorithm.
public func rankDivergence(expected: [String], got: [String]) -> Double {
