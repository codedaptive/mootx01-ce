...
public struct GauntletProfile: Sendable, Equatable {
    ...
    public init(tierCounts: [NoiseTier: Int], distractorsPerNeedle: Int) {
    ...
    public static func evenMix(perTier: Int, distractorsPerNeedle: Int) -> GauntletProfile {
...
public struct GauntletGenerator {
    ...
    public let profile: GauntletProfile

    public init(profile: GauntletProfile) {
    ...
    public func generate(seed: UInt64) -> GauntletCorpus {
