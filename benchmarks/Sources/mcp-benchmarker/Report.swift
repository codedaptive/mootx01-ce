...
struct BenchmarkReport: Codable, Sendable {
    ...
    /// which case the renderer omits the line. This is the source side of
    /// the transfer-verification latency comparison.
    ...
    func rendered() -> String {
        ...
        if sourceRecall.sampleCount > 0 {
            ...
            // Latency call-out: target recall vs source recall.
