...
changelog:
  - version: v0.10
    date: 2026-09-19
    description: "§5.1: `make stash-wing-estate` / `make restore-wing-estate DS= PORT=` move a built Form-2 wing estate to an external store's wing-store/<port>/<ds> and back, refusing while a resident still serves it."
  - version: v0.9
    date: 2026-09-17
...
| `make stash-wing-estate DS= PORT= EXTERNAL=` / `make restore-wing-estate …` | Move a built Form-2 wing estate out to an external store (`wing-store/<port>/<ds>`) and back; refused while a resident still serves it. |
