...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--kind", choices=("encoder", "cross-encoder"), default="encoder",
                        help="encoder: CLS-pooled [B, dim] output; cross-encoder: one logit per pair, [B] output")
...
def main() -> int:
    ...
    if cross:
        ...
        metadata.license = "Apache-2.0"
        metadata.model_description = (
            "snowflake-arctic-embed-s sentence encoder, CLS pooled, float32, dynamic batch and sequence. "
